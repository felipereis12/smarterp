...
--
-- Table structure for table `refund_erp_configurations`
--

DROP TABLE IF EXISTS `refund_erp_configurations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `refund_erp_configurations` (
...
--
-- Dumping data for table `refund_erp_configurations`
--

LOCK TABLES `refund_erp_configurations` WRITE;
/*!40000 ALTER TABLE `refund_erp_configurations` DISABLE KEYS */;
/*!40000 ALTER TABLE `refund_erp_configurations` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-11-21 18:07:46
