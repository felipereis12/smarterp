...
--
-- Table structure for table `invoice_customer_erp_configurations`
--

DROP TABLE IF EXISTS `invoice_customer_erp_configurations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `invoice_customer_erp_configurations` (
...
--
-- Dumping data for table `invoice_customer_erp_configurations`
--

LOCK TABLES `invoice_customer_erp_configurations` WRITE;
/*!40000 ALTER TABLE `invoice_customer_erp_configurations` DISABLE KEYS */;
/*!40000 ALTER TABLE `invoice_customer_erp_configurations` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-11-27 18:51:30
