...
--
-- Table structure for table `receipt_from_to`
--

DROP TABLE IF EXISTS `receipt_from_to`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `receipt_from_to` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `rft_unique` (`country`,`origin_system`,`order_to_cash_operation`,`receivable_transaction_type`,`erp_receivable_customer_identification`,`erp_business_unit`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `receipt_from_to`
--

LOCK TABLES `receipt_from_to` WRITE;
/*!40000 ALTER TABLE `receipt_from_to` DISABLE KEYS */;
INSERT INTO `receipt_from_to` VALUES (2,'2019-11-27 17:15:07','Brazil','smartsystem','franchise_conciliator','credit_card_recurring','01027058000191','BR02 - SMARTFIN'),(3,'2019-11-27 17:20:53','Brazil','smartsystem','person_plan','credit_card_recurring','01027058000191','BR01 - SMARTFIT');
/*!40000 ALTER TABLE `receipt_from_to` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-11-27 18:52:11
