...
and order_to_cash.id = '<Colocar aqui o Id order_to_cash do registro que foi enviado para o Oracle>'
and order_to_cash.minifactu_id = '<Colocar aqui o Id invoice_customer do registro que foi enviado para o Oracle>';