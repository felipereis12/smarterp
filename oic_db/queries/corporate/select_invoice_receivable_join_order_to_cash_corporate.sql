...
and otc.origin_system = 'biosystem' -- Integração em paralelo por origem (SmartFit, BioRitmo, etc...)
and otc.operation = 'corporate_plan' -- Integração em paralelo por operação (plano de alunos, plano corporativo, etc...)
