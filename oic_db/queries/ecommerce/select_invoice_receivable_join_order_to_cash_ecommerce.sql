...
and order_to_cash.origin_system = 'magento' -- Integração em paralelo por origem (SmartFit, BioRitmo, etc...)
and order_to_cash.operation = 'uniform_plan' -- Integração em paralelo por operação (plano de alunos, plano corporativo, etc...)
