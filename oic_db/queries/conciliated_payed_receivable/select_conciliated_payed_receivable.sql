select 
    ...
    ,RTRIM (concat(identification_financial_responsible,'Faturar')) as Customer_Site 
    ,cpr.bank_number
    ,cpr.bank_branch
    ,cpr.bank_account
	,time (cpr.created_at) as created_hour
    ,RTRIM (concat('RD_',cpr.bank_number,'_',cpr.bank_branch,'_',cpr.bank_account)) as Receipt_Method
    ,rec.conciliator_id
...
on crc.erp_customer_id = rec.erp_receivable_customer_id
